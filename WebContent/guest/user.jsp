...
<body>
	...
	<div class="cn-body container" >
		...
		<div class="col-sm-6">
			<form class="form-horizontal" action="<%=basePath%>guest.do/insertUser.do" method="post" onsubmit="return checkForm()">
				<div class="form-group">
					<label for="loginName" class="col-sm-3 control-label">用户名:</label>
					<div class="col-sm-8">
						<input type="text" style="width: 200px;display:inline-block;" class="form-control" id="loginName" name="loginName" placeholder="your login name" onchange="checkLoginName(this.value)">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input type="text" style="width: 200px;" class="form-control" id="name" name="name" placeholder="your ready name">
					</div>
					<font color="red" size="5px">*</font>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-8">
						<label class="radio-inline">
						  <input type="radio" name="sex" id="sex1" value="option1" checked="checked"> 男
						</label>
						<label class="radio-inline">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input type="tel" class="form-control" id="telephone" name="telephone" placeholder="135XXXXXXXX">
					</div>
					<font color="red" size="5px">*</font>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-8">
						<textarea class="form-control" id="description" name="description" placeholder="I am User" rows="2">
						</textarea>
					</div>
					<font color="red" size="5px">*</font>
				</div>
				<div class="form-group">
					<div class="col-sm-offset-6 col-sm-6">
						<button class="btn btn-primary" style="width: 100px;">注册</button>
					</div>
				</div>
			</form>
		</div>
		<div class="col-sm-2 text-center">
			<div style="margin-bottom:5px;">
				<img id="touxiang" src="<%=basePath%>download/imges01.png" style="width:100px;height:100px;">
			</div>
